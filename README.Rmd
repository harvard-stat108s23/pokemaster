...
The goal of `pokemaster` is to explore the Pokémon API. This package exploits the information of the Pokémon of the first 3 generations (which corresponds to the ids 1 to 386). The users can first create a data frame of the Pokémons of interest. It then helps you generate a Pokémon team. You can also see the relevant stats of your team and create a graph of the team including the selected Pokémons. Our intended audience are Pokémon enthusiasts as well as gamers in general. For more general information about Pokémon, you can visit [Bulbapedia](https://bulbapedia.bulbagarden.net/wiki/List_of_Pok%C3%A9mon_by_National_Pok%C3%A9dex_number).
