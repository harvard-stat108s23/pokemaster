...
- The third function is **pokecard**, which generates a flashcard of the team. It takes the input of vector of up to 6 Pokémons and has an output of an image/collage with the sprites of the Pokémons. 
